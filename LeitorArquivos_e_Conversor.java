...
//Biblioteca para criar e escrever em um novo arquivo
    ...
    private static String converterParaBinario(String instrucao) {
        ...
        switch (op) {
            ...
            case "sltu":
                ...
                binario.append(opcodes.get(op)).append(rs).append(rt).append(rd).append(shamt).append(functs.get(op)); // Monta a instrução binária
                break;
            case "sll":
            case "srl":
            case "sra":
            ...
            case "mtlo":
                rd = registradores.get(partes[1]); // Registrador de destino
                binario.append(opcodes.get(op)).append("0000000000").append(rd).append("00000").append(functs.get(op)); // Monta a instrução binária
                break;
            case "mult":
            case "div":
            case "divu":
